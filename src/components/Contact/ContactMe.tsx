  ...
  return (
    <div className="h-full w-full flex flex-col md:flex-row justify-center items-center lg:space-x-20 px-12">
      ...
      >
        ...
        />
        <div className="flex w-full flex-col xl:flex-row justify-around pt-0 py-10">
          <input
            type="text"
            placeholder="Your name"
            className="w-full my-5 xl:my-0 xl:w-[35%] text-xl lg:text-2xl focus:outline-none placeholder:font-semibold border-b-4 pb-1 border-gray-400"
          ...
          <input
            ...
            className="w-full xl:w-[35%] text-xl lg:text-2xl focus:outline-none placeholder:font-semibold border-b-4 pb-1 border-gray-400"
