...
export default function Blog({
  ...
  return (
    <Link
      href={blog.url}
      target="_blank"
      className="group mr-10 flex h-[400px] w-[97vw] flex-col overflow-hidden rounded-xl bg-[#088395] text-white md:h-[500px] md:w-[800px]"
    >
      <div
        className="transition-brightness h-full w-full bg-[#f0f0f0] bg-cover bg-center brightness-90 duration-100 group-hover:brightness-[80%]"
      ...
      <div className="px-3 py-2">
        ...
        <div className="flex pt-3">
          <div
            style={{
              backgroundImage: `url(${authorPicUrl})`,
            }}
            className="mr-2 h-10 w-10 rounded-full bg-cover bg-center md:h-12 md:w-12"
          />
          <div>
